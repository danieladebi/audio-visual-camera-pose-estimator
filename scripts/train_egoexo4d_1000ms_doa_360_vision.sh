torchrun --nproc_per_node=4 train.py \
    --train_dataset "EgoExo4D(split='train', use_direct_doa=True, resolution=(256, 256),embedding_type='embeddings_doa_1000ms_alt', sound_size=1000, use_img=True, transform=ColorJitter)" \
    ...
    --freeze_encoder \
    --output_dir "checkpoints/_egoexo4d-vision_audio_doa_360_1000ms-512_"