torchrun --nproc_per_node=8 train.py \
    --train_dataset "EgoExo4D(split='train', resolution=(256, 256),embedding_type='embeddings_doa_500ms', sound_size=500, use_doa=True, transform=ColorJitter)" \
    ...
    --output_dir "checkpoints/_egoexo4d-500ms_doa_cp_"